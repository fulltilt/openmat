...
export default function HomePage() {
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-blue-50 to-white">
      ...
      <section className="flex justify-center bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 py-12 text-white md:py-24 lg:py-32 xl:py-48">
      ...
      <section className="flex justify-center bg-white py-12 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
      ...
      {/* <section className="w-full bg-gradient-to-r from-blue-800 via-purple-800 to-blue-900 py-12 text-white md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <div className="flex justify-center max-w-sm space-y-2">
